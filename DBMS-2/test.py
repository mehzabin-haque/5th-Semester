...
accuracy_file = open('C:/Users/HP/Desktop/DBMS/Skin Detection/Accuracy_data.txt', 'w')
k_fold = 5
train = 500
test = 55
...
image_folder = 'C:/Users/HP/Desktop/DBMS/Skin Detection/ibtd/ibtd'
mask_folder = 'C:/Users/HP/Desktop/DBMS/Skin Detection/ibtd/ibtd/Mask'
...
for ki in range(k_fold):
    ...
    file = open('C:/Users/HP/Desktop/DBMS/Skin Detection/data.txt', 'w')
    ...
    for index in range(train):
        img = Image.open('C:/Users/HP/Desktop/DBMS/Skin Detection/ibtd/ibtd/'+str(indices[index])+'.jpg')
        mask = Image.open('C:/Users/HP/Desktop/DBMS/Skin Detection/ibtd/ibtd/Mask/'+str(indices[index])+'.bmp')
    ...
    f = open('C:/Users/HP/Desktop/DBMS/Skin Detection/data.txt', 'r')
    threshold = 1.0
    count = 0
    for i in range(256):
        for j in range(256):
    ...
    for index in range(test):                                     
        testImg = Image.open('C:/Users/HP/Desktop/DBMS/Skin Detection/ibtd/ibtd/'+str(indices[index+train])+'.jpg')
        testMask = Image.open('C:/Users/HP/Desktop/DBMS/Skin Detection/ibtd/ibtd/Mask/'+str(indices[index+train])+'.bmp')
        pixel = testImg.load()
